...
LastEditTime: 2024-04-06 19:55:28
LastEditors: 孙石泉
...
class Host_Utils(object):
    ...
    def __init__(self):
        ...
        self.get_host_ip_method = re.compile(r'\S+\s+(?P<ip>\d+.\d+.\d+.\d+)\s*$', re.S)
    ...
    def get_host_IO_load(self):
        ...
        try:
            ...
            print("<get_state.py> get NAS's IO_load fail")
    ...
    def get_host_Disk_remaining_capacity(self):
        ...
        try:
            ...
            print("<get_state.py> get NAS's remaining_capacity fail")
